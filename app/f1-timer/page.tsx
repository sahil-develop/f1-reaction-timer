      ...
      {open && (
        <div className="px-4 pb-4 space-y-2 animate-fade-in">
          <ol className="space-y-2 text-xs text-zinc-400 font-mono list-decimal list-inside">
            <li>Set your <span className="text-white">target reaction time</span> in milliseconds (50–9999 ms).</li>
            <li>Press <span className="text-[#E8002D]">START</span> or <kbd className="bg-[#222] border border-[#333] rounded px-1 text-[10px]">Space</kbd> to begin the light sequence.</li>
            <li>Watch 5 red lights illuminate one by one — <span className="text-yellow-400">do not press yet.</span></li>
            <li>When all lights <span className="text-white">go out</span>, press <span className="text-green-400">REACT</span> or <kbd className="bg-[#222] border border-[#333] rounded px-1 text-[10px]">Space</kbd> as fast as possible.</li>
            <li>Pressing <span className="text-yellow-400">before the lights go out</span> is a false start!</li>
            <li>Beat your target time and climb the leaderboard.</li>
          </ol>
          <div className="mt-3 pt-3 border-t border-[#1e1e1e] grid grid-cols-2 gap-2 text-[10px] font-mono text-zinc-600">
            <div><span className="text-zinc-400">F1 Avg:</span> ~200 ms</div>
            <div><span className="text-zinc-400">Human Avg:</span> ~250 ms</div>
            <div><span className="text-zinc-400">Elite:</span> &lt;150 ms</div>
            <div><span className="text-zinc-400">False start:</span> &lt;100 ms</div>
          </div>
        </div>
      )}
    </div>
...
export default function F1TimerPage() {
